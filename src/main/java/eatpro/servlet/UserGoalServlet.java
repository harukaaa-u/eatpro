...
import eatpro.dal.UserGoalsDao;
...
//                UserGoals goal = new UserGoals(userName, goalType, targetDate, targetValue, status);
...
//                UserGoals goal = userGoalsDao.updateGoalById(goalId, new UserGoals(userName, goalType, targetDate, targetValue, status));
//                if(goal != null) {
