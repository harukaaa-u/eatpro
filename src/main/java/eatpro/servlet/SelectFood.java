...
public class SelectFood extends HttpServlet {
	...
	protected MealDetailsDao mealDetails;
	@Override
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String breakfastId = req.getAttribute("breakfast");
		String lunchId = req.getAttribute("lunch");
		String dinnerId = req.getAttribute("dinner");
		String snackId = req.getAttribute("snack");
