 ...
 * 3. Add the Connector/J JAR to your build path. This allows your application to use the
...
public class ConnectionManager {
	...
	private final String schema = "EatProDB";
	...
	public Connection getConnection() throws SQLException {
		...
		try {
			...
			// Otherwise, Tom cat may have issues loading libraries in the proper order.
